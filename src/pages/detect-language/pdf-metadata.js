...
const MetaDataOfLinks = () => {
    ...
    const findDifference = (publicationDate, currentDate) => {
        const dateFormats = ["DD-MM-YYYY", "YYYY-MM-DD", "MM-DD-YYYY", "DD/MM/YYYY", "YYYY/DD/MM", "MM/DD/YYYY"]
    ...
    const handleFindMetaData = async () => {
        ...
        const dateGapsDetails = metaDataList?.map((meta) => {
            ...
            return {
                ...meta,
                "Date Difference - Created Date": findDifference(meta["Publication Date"], meta['New Created Date']),
                "Date Difference - Modified Date": findDifference(meta["Publication Date"], meta['New Modified Date'])
            }
        })
    ...
    // useEffect(() => {
    //     if (metaDetails) {
    //         const dateGapsDetails = metaDetails?.map((meta) => {
    ...
    //         setFinalResult(dateGapsDetails)
    //     }
    // }, [metaDetails, setFinalResult])
